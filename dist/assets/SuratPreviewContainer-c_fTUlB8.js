import{j as t}from"./ui-vendor-C6CR1JGj.js";const r=({children:i})=>t.jsxs("div",{className:"preview-container border rounded-lg bg-white shadow",style:{width:"100%",maxWidth:"100%",margin:0,padding:0,fontFamily:"inherit",fontSize:15,background:"#fff",borderRadius:0},children:[t.jsx("style",{children:`
      @media print {
