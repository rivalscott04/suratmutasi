import{j as e,W as b,au as Na,Z as _a,Y as wa,a0 as Z,ap as R,aD as Re,ar as Le,ae as Sa,_ as ne,aE as Ie,aF as Da,aq as Me,aA as re}from"./ui-vendor-BCnv6AUJ.js";import{g as Aa,d as Pa,r as d}from"./react-vendor-C8WR5ETM.js";import{C as N,c as _,a as C,b as F}from"./card-DryeQ-bV.js";import{u as Ta,a as le,B as r,b as w,D as L,e as I,f as M,g as W,k as Q,j as ee,m as Ca}from"./index-rrBGIed5.js";import{A as de,a as ce,b as oe,c as me,d as ue,e as pe,g as We,f as he}from"./alert-dialog-BjdMa1Ob.js";import{T as ae}from"./textarea-B5PSWFpo.js";import{L as Ue}from"./label-DlXdrso_.js";import{S as Oe}from"./switch-BOdZwrX9.js";const Ua=()=>{var Ce,Fe;const{pengajuanId:x}=Aa(),S=Pa(),{user:l,token:p,isAuthenticated:xe,originalUser:Fa,isImpersonating:$a}=Ta(),[s,ge]=d.useState(null),[U,je]=d.useState([]),[O,se]=d.useState([]),[Je,fe]=d.useState(!0),[be,c]=d.useState(null),[g,ze]=d.useState(null),[qe,ve]=d.useState(!1),[Ge,J]=d.useState(!1),[He,z]=d.useState(!1),[Ve,D]=d.useState(!1),[Ye,q]=d.useState(!1),[Xe,y]=d.useState(!1),[Ze,G]=d.useState(!1),[Qe,H]=d.useState(!1),[ea,A]=d.useState(""),[V,te]=d.useState(""),[$,ie]=d.useState(""),[aa,sa]=d.useState(""),[ye,ta]=d.useState(""),[o,h]=d.useState(!1),[Y,ke]=d.useState(null),[Ne,ia]=d.useState(!1);(Ce=s==null?void 0:s.files)!=null&&Ce.some(a=>a.file_category==="admin_wilayah"),d.useEffect(()=>{if(!xe){S("/");return}x&&P()},[xe,S,x]),d.useEffect(()=>{const a=()=>{const t=window.pageYOffset||document.documentElement.scrollTop;ia(t>50)};return a(),window.addEventListener("scroll",a,{passive:!0}),()=>window.removeEventListener("scroll",a)},[]);const P=async()=>{var a,t,n;try{fe(!0);const i=await le(`/api/pengajuan/${x}`,p);if(i.success)if(ge(i.data.pengajuan),Array.isArray(i.data.requiredFiles)?je(i.data.requiredFiles):je([]),(l==null?void 0:l.role)==="admin_wilayah")try{const u=await le(`/api/admin-wilayah/pengajuan/${x}`,p),f=((a=u==null?void 0:u.adminWilayahFileConfig)==null?void 0:a.required)||((n=(t=u==null?void 0:u.data)==null?void 0:t.adminWilayahFileConfig)==null?void 0:n.required)||[];se(f.map(k=>k.file_type))}catch{se([])}else se([]);else c(i.message||"Gagal mengambil data pengajuan")}catch(i){console.error("Error fetching pengajuan data:",i),c("Terjadi kesalahan saat mengambil data pengajuan")}finally{fe(!1)}},na=async()=>{try{h(!0);const a=T?await Q(`/api/admin-wilayah/pengajuan/${x}/approve`,{notes:V},p):await ee(`/api/pengajuan/${x}/approve`,{catatan:V},p);a.success?(A("Pengajuan berhasil disetujui!"),y(!0),J(!1),te(""),await P()):c(a.message||"Gagal approve pengajuan")}catch(a){console.error("Error approving pengajuan:",a),c("Terjadi kesalahan saat approve pengajuan")}finally{h(!1)}},ra=async()=>{try{h(!0);const a=T?await Q(`/api/admin-wilayah/pengajuan/${x}/reject`,{rejection_reason:$},p):await ee(`/api/pengajuan/${x}/reject`,{rejection_reason:$},p);a.success?(A("Pengajuan berhasil ditolak!"),y(!0),z(!1),ie(""),await P()):c(a.message||"Gagal reject pengajuan")}catch(a){console.error("Error rejecting pengajuan:",a),c("Terjadi kesalahan saat reject pengajuan")}finally{h(!1)}},la=async()=>{try{h(!0);const a=await Q(`/api/pengajuan/${x}/final-approve`,{notes:V},p);a.success?(A("Pengajuan berhasil disetujui final!"),y(!0),G(!1),te(""),await P()):c(a.message||"Gagal approve final pengajuan")}catch(a){console.error("Error final approving pengajuan:",a),c("Terjadi kesalahan saat approve final pengajuan")}finally{h(!1)}},da=async()=>{try{h(!0);const a=await Q(`/api/pengajuan/${x}/final-reject`,{rejection_reason:$},p);a.success?(A("Pengajuan berhasil ditolak final!"),y(!0),H(!1),ie(""),await P()):c(a.message||"Gagal reject final pengajuan")}catch(a){console.error("Error final rejecting pengajuan:",a),c("Terjadi kesalahan saat reject final pengajuan")}finally{h(!1)}},ca=async()=>{try{h(!0);const a=await ee(`/api/pengajuan/${x}/resubmit`,{},p);a.success?(A("Pengajuan berhasil diajukan ulang!"),y(!0),await P()):c(a.message||"Gagal resubmit pengajuan")}catch(a){console.error("Error resubmitting pengajuan:",a),c("Terjadi kesalahan saat resubmit pengajuan")}finally{h(!1)}},oa=async()=>{try{h(!0);const a=await Ca(`/api/pengajuan/${x}`,p);a.success?(A("Pengajuan berhasil dihapus!"),y(!0),D(!1),setTimeout(()=>{S("/pengajuan")},2e3)):(c(a.message||"Gagal menghapus pengajuan"),D(!1))}catch(a){console.error("Error deleting pengajuan:",a),c("Terjadi kesalahan saat menghapus pengajuan"),D(!1)}finally{h(!1)}},ma=a=>{const n={draft:{label:"DRAFT",className:"bg-gray-100 text-gray-800"},submitted:{label:"SUBMITTED",className:"bg-blue-100 text-blue-800"},approved:{label:"APPROVED",className:"bg-green-100 text-green-800"},rejected:{label:"REJECTED",className:"bg-red-100 text-red-800"},resubmitted:{label:"RESUBMITTED",className:"bg-yellow-100 text-yellow-800"},admin_wilayah_approved:{label:"ADMIN_WILAYAH_APPROVED",className:"bg-green-200 text-green-800"},admin_wilayah_rejected:{label:"ADMIN_WILAYAH_REJECTED",className:"bg-red-200 text-red-800"},final_approved:{label:"FINAL_APPROVED",className:"bg-green-600 text-white"},final_rejected:{label:"FINAL_REJECTED",className:"bg-red-600 text-white"}}[a]||{label:a.toUpperCase(),className:"bg-gray-100 text-gray-800"};return e.jsx(w,{className:n.className,children:n.label})},ua=a=>({guru:"Guru",eselon_iv:"Eselon IV",fungsional:"Fungsional",pelaksana:"Pelaksana"})[a]||a,B=a=>({surat_pengantar:"Surat Pengantar",surat_permohonan_dari_yang_bersangkutan:"Surat Permohonan Dari Yang Bersangkutan",surat_keputusan_cpns:"Surat Keputusan CPNS",surat_keputusan_pns:"Surat Keputusan PNS",surat_keputusan_kenaikan_pangkat_terakhir:"Surat Keputusan Kenaikan Pangkat Terakhir",surat_keputusan_jabatan_terakhir:"Surat Keputusan Jabatan Terakhir",skp_2_tahun_terakhir:"SKP 2 Tahun Terakhir",surat_keterangan_bebas_temuan_inspektorat:"Surat Keterangan Bebas Temuan Yang Diterbitkan Inspektorat Jenderal Kementerian Agama",surat_keterangan_anjab_abk_instansi_asal:"Surat Keterangan Anjab dan ABK terhadap jabatan PNS dari instansi asal",surat_keterangan_anjab_abk_instansi_penerima:"Surat Keterangan Anjab dan ABK terhadap jabatan PNS dari instansi penerima",surat_pernyataan_tidak_hukuman_disiplin:"Surat Pernyataan Tidak Pernah Dijatuhi Hukuman Disiplin Tingkat Sedang atau Berat Dalam 1 (satu) Tahun Terakhir Dari PPK",surat_persetujuan_mutasi_asal:"Surat Persetujuan Mutasi dari ASAL dengan menyebutkan jabatan yang akan diduduki",surat_lolos_butuh_ppk:"Surat Lolos Butuh dari Pejabat Pembina Kepegawaian instansi yang dituju",peta_jabatan:"Peta Jabatan",hasil_uji_kompetensi:"Hasil Uji Kompetensi",hasil_evaluasi_pertimbangan_baperjakat:"Hasil Evaluasi dan Pertimbangan (BAPERJAKAT)",anjab_abk_instansi_asal:"Anjab/Abk Instansi Asal",anjab_abk_instansi_penerima:"Anjab/Abk Instansi Penerima",surat_keterangan_tidak_tugas_belajar:"Surat Keterangan Tidak Sedang Tugas Belajar",sptjm_pimpinan_satker_asal:"SPTJM Pimpinan Satker dari Asal",sptjm_pimpinan_satker_penerima:"SPTJM Pimpinan Satker dari Penerima",surat_rekomendasi_instansi_pembina:"Surat Rekomendasi Instansi Pembina",surat_pengantar_permohonan_rekomendasi:"Surat Pengantar Permohonan Rekomendasi",surat_rekomendasi_kanwil_khusus:"Surat Rekomendasi Kanwil Khusus",surat_persetujuan_kepala_wilayah:"Surat Persetujuan Kepala Wilayah",surat_pernyataan_tidak_ikatan_dinas:"Surat Pernyataan Tidak Ikatan Dinas",surat_pernyataan_tidak_tugas_belajar:"Surat Pernyataan Tidak Tugas Belajar",surat_keterangan_kanwil:"Surat Keterangan Kanwil",surat_rekomendasi_kanwil:"Surat Rekomendasi Kanwil"})[a]||a.replace(/_/g," ").toUpperCase(),_e=async(a,t,n)=>{try{console.log("🔍 Debug handleVerifyFile:",{fileId:a,verificationStatus:t,notes:n,token:p}),ke(a);const i={verification_status:t,verification_notes:n};console.log("📤 Request data:",i);const u=await ee(`/api/pengajuan/files/${a}/verify`,i,p);console.log("📥 Response:",u),u.success?ge(f=>f&&{...f,files:f.files.map(k=>k.id===a?{...k,verification_status:t,verified_by:(l==null?void 0:l.email)||(l==null?void 0:l.id),verified_at:new Date().toISOString()}:k)}):c(u.message||"Gagal verifikasi file")}catch(i){console.error("❌ Error verifying file:",i),c("Terjadi kesalahan saat verifikasi file")}finally{ke(null)}},pa=async()=>{try{h(!0);const a=await le(`/api/pengajuan/${x}/print-report`,p);a.success?xa(a.data):c(a.message||"Gagal generate laporan")}catch(a){console.error("Error generating print report:",a),c("Terjadi kesalahan saat generate laporan")}finally{h(!1),q(!1)}},ha=()=>{try{ga(),q(!1)}catch(a){console.error("Error generating final print report:",a),c("Terjadi kesalahan saat generate laporan final")}},xa=a=>{var i;const t=window.open("","_blank");if(!t)return;const n=`
    ...
    `;a.document.write(f),a.document.close(),a.print()},v=a=>new Date(a).toLocaleDateString("id-ID",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}),we=a=>{const n=["Bytes","KB","MB","GB"],i=Math.floor(Math.log(a)/Math.log(1024));return parseFloat((a/Math.pow(1024,i)).toFixed(2))+" "+n[i]},Se=async a=>{try{const t=await fetch(`/api/pengajuan/files/${a.id}`,{headers:{Authorization:`Bearer ${p}`}});if(!t.ok)throw new Error("Gagal mengambil file");const n=await t.blob(),i=URL.createObjectURL(n);ze({...a,blobUrl:i}),ve(!0)}catch(t){console.error("Error previewing file:",t),c("Gagal preview file. Silakan coba lagi.")}},De=a=>{window.open(`/api/pengajuan/files/${a.id}`,"_blank")},j=(l==null?void 0:l.role)==="admin",T=(l==null?void 0:l.role)==="admin_wilayah",Ae=(()=>{if(!s)return!1;const a=new Set([...U,...O]);for(const t of a){const n=s.files.find(i=>i.file_type===t);if(n&&n.verification_status==="pending")return!0}return!1})(),K=((s==null?void 0:s.status)==="draft"||(s==null?void 0:s.status)==="rejected")&&(j||(s==null?void 0:s.created_by)===(l==null?void 0:l.id))&&!Ae,Pe=(s==null?void 0:s.status)==="draft"&&(j||(s==null?void 0:s.created_by)===(l==null?void 0:l.id))&&!Ae,ja=j&&(s==null?void 0:s.status)==="submitted"||T&&((s==null?void 0:s.status)==="approved"||(s==null?void 0:s.status)==="submitted"),fa=j&&(s==null?void 0:s.status)==="submitted"||T&&((s==null?void 0:s.status)==="approved"||(s==null?void 0:s.status)==="submitted"),ba=((s==null?void 0:s.status)==="rejected"||(s==null?void 0:s.status)==="draft")&&(l==null?void 0:l.role)!=="user",E=(()=>{if(!s)return!1;const a=new Set([...U,...O]);if(a.size===0)return!1;for(const t of a){const n=s.files.find(i=>i.file_type===t);if(!n||n.verification_status!=="approved")return!1}return!0})(),Te=(()=>{if(!s)return!1;const a=new Set([...U,...O]);for(const t of a){const n=s.files.find(i=>i.file_type===t);if(!n||n.verification_status==="rejected")return!0}return!1})(),va=!Te,ya=(()=>{if(!s)return!1;const a=s.files.filter(t=>t.file_category==="admin_wilayah");if(a.length===0)return!1;for(const t of a)if(t.verification_status!=="approved")return!1;return!0})(),ka=(()=>{if(!s)return!1;const a=s.files.filter(t=>t.file_category==="admin_wilayah");if(a.length===0)return!1;for(const t of a)if(t.verification_status==="rejected")return!0;return!1})();return Je?e.jsx("div",{className:"container mx-auto p-6",children:e.jsx(N,{children:e.jsxs(_,{className:"flex items-center justify-center py-12",children:[e.jsx(b,{className:"h-8 w-8 animate-spin mr-2"}),e.jsx("span",{children:"Memuat detail pengajuan..."})]})})}):s?e.jsxs("div",{className:"container mx-auto p-6",children:[e.jsx("style",{dangerouslySetInnerHTML:{__html:`
