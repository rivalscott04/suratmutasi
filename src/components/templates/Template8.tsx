    ...
    <div className="template-preview bg-white text-black" style={{ fontFamily: 'Arial, sans-serif', fontSize: '11pt', margin: 0, padding: 0 }}>
      ...
      <div className="mx-4">
        ...
        <div className="text-center font-bold mb-4">
          <strong>SURAT PERSETUJUAN PENERIMAAN</strong>
        </div>
      
        {/* Nomor Surat */}
        <div className="text-center mb-5">
          Nomor : B-{data.nosrt}/Kk.18.{data.office?.kode_kabko || data.kode_kabko || "-"}/1/Kp.07.6/{data.blnno}/{data.thnno}
        </div>
        ...
        <div className="text-justify mb-4">
          ...
          <p>
            Demikian surat rekomendasi penerimaan ini dibuat dengan sebenar-benarnya untuk dapat dipergunakan sebagaimana mestinya.
          </p>
        </div>
