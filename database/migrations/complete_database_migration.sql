...
-- Urutan: CREATE TABLE -> INDEX -> FOREIGN KEY
-- =====================================================

-- 1. CREATE TABLES SEMUA DULU (dengan IF NOT EXISTS)
...
-- 2. INDEXES (dengan IF NOT EXISTS)
CREATE INDEX IF NOT EXISTS idx_offices_kabkota ON offices(kabkota);
...
-- 3. FOREIGN KEYS (dengan IF NOT EXISTS)
ALTER TABLE users ADD CONSTRAINT IF NOT EXISTS fk_users_office_id FOREIGN KEY (office_id) REFERENCES offices(id) ON DELETE SET NULL;

ALTER TABLE pegawai ADD CONSTRAINT IF NOT EXISTS fk_pegawai_office_id FOREIGN KEY (office_id) REFERENCES offices(id) ON DELETE SET NULL;

ALTER TABLE letters ADD CONSTRAINT IF NOT EXISTS fk_letters_created_by FOREIGN KEY (created_by) REFERENCES users(id) ON DELETE SET NULL;

ALTER TABLE letters ADD CONSTRAINT IF NOT EXISTS fk_letters_office_id FOREIGN KEY (office_id) REFERENCES offices(id) ON DELETE SET NULL;

ALTER TABLE letters ADD CONSTRAINT IF NOT EXISTS fk_letters_recipient_employee_nip FOREIGN KEY (recipient_employee_nip) REFERENCES pegawai(nip) ON DELETE SET NULL;

ALTER TABLE pengajuan ADD CONSTRAINT IF NOT EXISTS fk_pengajuan_pegawai_nip FOREIGN KEY (pegawai_nip) REFERENCES pegawai(nip) ON DELETE SET NULL;

ALTER TABLE pengajuan ADD CONSTRAINT IF NOT EXISTS fk_pengajuan_created_by FOREIGN KEY (created_by) REFERENCES users(id) ON DELETE SET NULL;

ALTER TABLE pengajuan ADD CONSTRAINT IF NOT EXISTS fk_pengajuan_office_id FOREIGN KEY (office_id) REFERENCES offices(id) ON DELETE SET NULL;

ALTER TABLE pengajuan_files ADD CONSTRAINT IF NOT EXISTS fk_pengajuan_files_pengajuan_id FOREIGN KEY (pengajuan_id) REFERENCES pengajuan(id) ON DELETE CASCADE;
